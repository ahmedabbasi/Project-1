    ...
    $("#go").on("click",function(event){
      ...
      $(".artist-name").append(channelName);
       ...
       $.ajax({
        ...
        var object1='<iframe width=\"100%\" height=\"100%\" src =\"https://www.youtube.com/embed/' +vidId1+ '\"></iframe>';
        var vidId2=result.items[5].id.videoId
        var object2='<iframe width=\"100%\" height=\"100%\"  src =\"https://www.youtube.com/embed/' +vidId2+ '\"></iframe>';
